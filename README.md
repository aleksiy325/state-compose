...
This is a template repo. Click the green [Use this template](https://github.com/kbysiec/state-compose/generate) button to get started.
...
```bash
git clone https://github.com/kbysiec/state-compose.git
cd state-compose
npm i
```
